...
import static com.unisinsight.vdp.core.generator.ProjectConstant.*;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:postgresql://192.168.105.181:5432/vdp?currentSchema=core";
    ...
    //@author
    private static final String AUTHOR = "hujun [KF.hujunA@h3c.com]";

    //@date
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());

    //API 前缀
    private static final String BASEREQUESTMAPPING_PREFIX = "/api/v1/core";

    public static void main(String[] args) {

        genCode("","cruise_preset");
